                        ...
                        @foreach ($test->questions as $question)
                            <div class="px-2 py-2 border rounded mb-2 bg-dark text-white">
                                ...
                                <div class="form-group px-2 py-2" style="background: #ffffff;color:#222222;">
                                    <div>Your Answer: <span style="font-weight:bold; font-size: 1rem" class="@if($question->marks_obtained > 0) text-success @else text-danger @endif"> {{ $question->your_answer }}</span></div>
